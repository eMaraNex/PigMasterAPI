...
export const earningsSchema = Joi.object({
    farm_id: Joi.string().uuid().required(),
    type: Joi.string().valid('pig_sale', 'urine_sale', 'manure_sale', 'other').required(),
...
export const earningsUpdateSchema = Joi.object({
    type: Joi.string().valid('pig_sale', 'urine_sale', 'manure_sale', 'other').optional(),
    pig_id: Joi.string().max(200).optional().allow(null), // Changed max to 200
...
export const paymentSchema = Joi.object({
  ...
  payment_mode: Joi.string().valid('mpesa', 'dpogroup', 'card', 'stripe', 'paypal'),
